...
public class BibliotecaController {
	...
	public ResponseEntity<Biblioteca> update(@PathVariable long id,@RequestBody Biblioteca novaBiblioteca){
		
		try {
			
			Biblioteca biblioteca = this.bibliotecaService.update(id, novaBiblioteca);
			return new ResponseEntity<>(biblioteca, HttpStatus.OK);
